...
- Established enterprise API integration architecture defining contract standards and interface patterns with backend teams, enabling frontend delivery independence from a distributed microservices backend.  
- Designed an API layer generation pipeline consuming OpenAPI gateway specifications, abstracting microservices complexity and eliminating manual hook and type authoring across all service integrations.  
- Bridged business strategy and engineering execution by translating product requirements into technical specifications, acceptance criteria, and architectural constraints.  
...
12/2021–06/2022 | Broomfield, Colorado  
Maintained and enhanced marketing and eCommerce websites. Collaborated with stakeholders for Adobe analytics tracking and A/B testing. Transitioned the Sitecore frontend to React components.
...
Developed frontend and administrative functionalities for marketing CMS websites using Umbraco (.NET). Integrated with Salesforce API for lead generation and translated UI specifications into technical requirements. PCI-compliant payment processing environment.
...
LinkedIn: https://www.linkedin.com/in/cherylcarpenter2015